...
function main() {
    ...
    for(let i=0;i<draws.length;i++) {
        ...
        newWinners = boards.filter(board => isBoardWinner(board, drawn));
        losers = boards.filter(board => !isBoardWinner(board, drawn));
    ...
    const score = boardScore(lastWinner, drawn)

    console.log("last winner score:", score);
}
